...
from seq2seq_conversation_model.seq2seq_conversation_model import FLAGS, \
    _buckets
...
class Chatbot():
    ...
    def __init__(self, model_dir):
        ...
        # Load vocabularies.
        vocab_path = os.path.join(seq2seq.FLAGS.data_dir,
                                  "vocab%d" % seq2seq.FLAGS.vocab_size)
    ...
    def generate_answer(self, enquiry):
        ...
        token_ids = data_utils.sentence_to_token_ids(enquiry, self.vocab,
                                                     fmm_tokenizer)
        if len(token_ids) == 0:
